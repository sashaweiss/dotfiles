...
tmux_conf_theme_status_left_bg='#aa5439,#28536c,#aa7739'  # burnt orange, turquoise, light blue
tmux_conf_theme_status_left_attr='bold,none,none'

# status right style
tmux_conf_theme_status_right_fg='#8a8a8a,#e4e4e4,#000000' # light gray, white, black
# tmux_conf_theme_status_right_bg='#080808,#d70000,#e4e4e4' # dark gray, red, white
tmux_conf_theme_status_right_bg='#080808,#5b2c70,#e4e4e4' # dark gray,light purple, white
...
# Use vi commands to move in copy/visual mode
...
source-file "$HOME"/dotfiles/machines/"$HOSTNAME"/tmux.conf
